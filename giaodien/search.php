...
<div class="ads-grid py-sm-5 py-4 all-product ">
        <div class="title_search ">
            <span class="keyword_search" style="font-family: Arial, Helvetica, sans-serif; color:#228B22;">TÌM KIẾM THEO TỪ KHOÁ:  <strong><?php echo $tukhoa ?></strong></span>
        </div>
        <h1 class="no_result_search" style="font-family: Arial, Helvetica, sans-serif; color:red"><?php echo $title_result ?> </h1>
