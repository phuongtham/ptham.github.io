					...
					<div class="side-bar p-sm-4 p-3">
						<div class="search-hotel border-bottom py-2 row">
							...
							>TÌM KIẾM SẢN PHẨM</h4>
								<input  class="col-md-8 col-sm-8 mr-1 ml-3 form-control" type="text" id="name" style="border:1px solid #e5e5e5">
								<button class="col-md-3 col-sm-3 btn btn-outline-success" id="submitSearch" style="text-align:center; font-size: 13px; font-weight:bold; border:1px solid #4CAF50" onclick="validatePrice()">Tìm Kiếm</button>
						</div>
						<!-- price -->
						<div class="range border-bottom py-2" style="font-weight: bold;" >
							...
							Từ:
                            <p><input class="form-control" id="min_price" type="text" style ="border:1px solid #e5e5e5" placeholder="VD: 0" /></p>
                            Đến:
                            <p><input  class="form-control" id="max_price" type="text" style ="border:1px solid #e5e5e5" placeholder="VD: 100000"  /></p>
						</div>
						...
						<div class="left-side border-bottom py-2">
							...
							<ul style="list-style-type:decimal;">
								...
								<li>
									...
									<span class="span" style="font-size: 20px; font-family: Arial, Helvetica, sans-serif; color: #585858;" ><?php echo $row_type_product['LOAI_SP']  ?></span>
								</li>
                                <?php
                                    }
                                ?>							
						...
						<div class="left-side border-bottom py-2">
							...
							<ul style="list-style-type:decimal;">
								...
								<li>
									...
									<span class="span" style="color: #585858; font-size :20px;" ><?php echo $row_size_product['KICH_THUOC']  ?></span>
								</li>
                                <?php
                                    }
                                ?>							
