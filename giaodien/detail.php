	...
	<div style="margin: 30px 0;" class="row chitiet">
		<div class="col-md-6 col-sm-12 images" style="padding-right: 5ex;">
			<div class="wrap"  style="padding-right: 5ex;">
				<img id="myImgDetail" class="item img-fluid" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; border-radius:6px;" src="images/product-items/<?php  echo $row_product_detail['HINH_ANH_URL'] ?>" id="img-product-detail" >
				<strong style="margin-top: 5px; font-size: 16px;">Hình ảnh Zoom In:</strong>
		...
		<div class="col-md-6 col-sm-12" style="padding-right: 6ex;">
				...
				<div class="price-chitiet">
					<span style="font-size: 22px;">Giá bán:</span>
				...
				<hr style=" border: 1px solid rgb(19, 17, 17); margin: 2ex 3px;">
				<div class="details">
					<span style="font-size:20px; font-weight:bold;">Thông tin sản phẩm:</span>
					<p style="font-size: 18px;"> <?php echo $row_product_detail['MO_TA'] ?> </p>
				</div>	
				...
				<form id="detailForm" action="<?php echo  $_SERVER['REQUEST_URI']; ?>" method="POST">
                    ...
                    <div class="btn-size_chitiet">
                            ...
                            <a href="index.php?quanly=detail&id=<?php echo $id ?>&sale=<?php echo $IDsale ?>&product=<?php echo $product++ ?>&size=<?php echo $size ?>">
                                <button type="button" <?php echo $disableSize["$size"] ?> class="btn-chitiet btn-outline-dark" style="border:1px solid black; font-size: 20px; width:8%;" id="btSize<?php echo $size ?>_detail">
				...
				<div class=" button-chitiet row">
					<button type="button" <?php echo $disable ?> id="btAddCart" class="btn btn-outline-primary col-md-4  col-sm-12" value="add" style=" text-align:center; margin-left: 18px;" onclick="checkQuanlity()"><a  style="font-weight: bold; text-decoration: none;"> Thêm Vào Giỏ Hàng</a> </button>
