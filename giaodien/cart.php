...
<div id="cart_container">
    ...
    <div id="footerCart" class="row">
        <div class="col-md-6 col-sm-6">
            <div style="margin:0 1% 0 20%; float:left"><b style="color: red;">Tổng Đơn: <?php if($total_price!="") echo "$total_price VNĐ"; else echo "$total_price 0 VNĐ"?></b></div>
            <div style="float:left" id="totalBill"></div>
        </div>     
        <div class="col-md-6 col-sm-6">
            <button class="btn btn-ouline-success" id="sa" style="border: none; background-color: blue; color:white; " 
			onclick="checkLogin()">Đặt Hàng</button>
            <form action="<?php echo  $_SERVER['REQUEST_URI']; ?>" method="POST">
            	<input type="hidden" name="cart" value="empty">
            	<button type="submit" class="btn btn-ouline-warning" style="background-color: red; margin-right:8%; border:none; color:white">
				Xóa tất cả</button>
            </form>
        </div>
    </div>
