...
<nav class="navbar navbar-expand-lg navbar-light menu " id="navbar">
		...
		<img src="images/logo.png" class="navbar-brand img-fluid " style="width: 35px;">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
		    <ul class="navbar-nav mr-auto">
                ...
                <a class="nav-link " href="index.php" style="color: #fff; font-family: Arial, Helvetica, sans-serif;">TRANG CHỦ <span class="sr-only">(current)</span></a>
                </li>
               
                <li class="nav-item <?php echo $product?> dropdown fullmenu" >
                <a class="nav-link " onclick="" id="navbarDropdown" href="index.php?quanly=product" style="font-family: Arial, Helvetica, sans-serif;" >
                SẢN PHẨM
                </a>
                ...
                ?>
                    <a class="dropdown-item" href="index.php?quanly=product&type=<?php echo $row_category['LOAI_SP']  ?>"><i class="fa fa-check-square"></i><?php echo $row_category['LOAI_SP'] ?></a> 
                <?php
                  }
                ?>
                </div>
                ...
                <a class="nav-link"  id="navbarDropdown" href="index.php?quanly=sale" style="font-family: Arial, Helvetica, sans-serif;">
                    KHUYẾN MÃI
                </a>
      ...
      <div id="myOverlay" class="overlaysearch">
			<span class="closebtn" style="box-shadow: none;" onclick="closeSearch()" title="Đóng Tìm Kiếm">×</span>
			<div class="overlay-content">
			  <form action="index.php?quanly=search" method ="post">
				<input type="text" style="font-weight: bold; color: #333; border:none; border-top-left-radius: 20px; border-bottom-left-radius: 20px; outline:none;"placeholder="Tìm Kiếm..." name="search_product">
				<button type="submit" name="search_submit" style="width:100px; border:none; border-top-right-radius: 20px; border-bottom-right-radius: 20px; background-color:#228B22; outline:none;"><i class="fa fa-search  text-light"></i></button>
			  </form>
			</div>
		  </div>	